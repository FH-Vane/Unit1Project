...
public class HeatEnergyRunner {
	...
	public static double tempChangeSolid(double mass, double startTemp, double endTemp, String endPhase,
			boolean endothermic) {
	...
	public static double tempChangeLiquid(double mass, double startTemp, double endTemp, String endPhase,
			boolean endothermic) {
		if (endPhase.equals("solid")) {
			endTemp = 0;
		}
	...
	public static double tempChangeVapor(double mass, double startTemp, double endTemp, String endPhase,
			boolean endothermic) {
		if (!endPhase.equals("vapor")) {
			endTemp = 100;
		}
	...
	public static double vaporization(double mass, boolean endothermic) {
		double energyChange;
		if (endothermic) {
			energyChange = mass * 2.257;
			System.out.print("Evaporation: " + energyChange + "kJ");
		} else {
			energyChange = -2.257 * mass;
			System.out.print("Condesation: " + energyChange + "kJ");
		}
		return energyChange;
	}
